...
//выделяем текущий пункт
    ...
    jQuery("body, div, p, span, h3, a, table, td, tr, tbody, thead, header, footer, section, li, ul").css("fontSize", "24px");
    jQuery("h1").css("fontSize", "26px");
    jQuery("h2").css("fontSize", "25px");
    jQuery("#infobardm, .dmchangea1, .dmchangea2, .dmchangea3, .dmdisableimage, .dmenableimage, .dmcolor1, .dmcolor2, .dmcolor3, .dmcolor4").css("fontSize", "26px");
...
//выделяем текущий пункт
	    ...
	    if (dmcookiesfont=='fontsize3') { //fontsize3 имеется в виду 23px
	    	//делаем все в 27 пикселях
    jQuery("body, div, p, span, h3, a, table, td, tr, tbody, thead, header, footer, section, li, ul").css("fontSize", "34px");
    jQuery("h1").css("fontSize", "36px");
    jQuery("h2").css("fontSize", "35px");
    jQuery("#infobardm, .dmchangea1, .dmchangea2, .dmchangea3, .dmdisableimage, .dmenableimage, .dmcolor1, .dmcolor2, .dmcolor3, .dmcolor4").css("fontSize", "30px");
